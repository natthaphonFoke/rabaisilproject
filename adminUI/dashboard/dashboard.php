...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="../question/index-admin.php">แบบทดสอบ</a></li>
    ...
    <header>
        <h1>dashboardแบบทดสอบระบายศิลป์</h1>
    </header>
        ...
        <div class="table-container mt-5">
            ...
            <script>
                function downloadFilteredCSV() {
                    let searchQuery = document.getElementById("searchInput").value.trim(); // ดึงค่าค้นหา
                    let payload = searchQuery === "" ? {
                        search: "all"
                    } : {
                        search: searchQuery
                    }; // ถ้าไม่มีการค้นหา ให้ดาวน์โหลดทั้งหมด
            ...
            <div class="mt-3 text-end">
                <button type="button" class="btn btn-custom" onclick="downloadFilteredCSV()">ดาวน์โหลดข้อมูล</button>
            </div>
            ...
            <table class="table modern-table" id="dataTable">
                ...
                <tbody>
                    <?php while ($row = $result_table->fetch_assoc()): ?>
                        <tr>
                            <!-- รหัสนักศึกษาเป็นลิงก์ไปที่ student_result.php -->
                            <td><a href="student_result.php?std_id=<?php echo $row['std_id']; ?>"><?php echo $row['std_id']; ?></a></td>

                            <!-- ชื่อ-นามสกุลเป็นลิงก์ไปที่ student_result.php -->
                            <td><a href="student_result.php?std_id=<?php echo $row['std_id']; ?>"><?php echo $row['name']; ?></a></td>
